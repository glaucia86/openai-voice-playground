# Lab 01 — Text to speech with OpenAI, Next.js 15, and TypeScript 7
...
[Portuguese version](tutorial.md) · [Optional environment module](../../../docs/00-configuracao-do-ambiente.md) · [Workshop index](../../../docs/README.md) · [Module 02 — Realtime →](../../lab-02-realtime-voice-agent/tutorial/tutorial-en.md)
...
- **Path B — rebuild from an empty directory:** create every folder and implement the slices in article order. Choose this for a hands-on workshop or deeper learning.

Both paths reach the same architecture. Pay attention to the terminal location printed in each section.
...
### 0.5 Path B: build the base from an empty directory
