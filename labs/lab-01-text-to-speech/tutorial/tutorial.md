# Laboratório 01 — Text to speech com OpenAI, Next.js 15 e TypeScript 7
...
Este workshop oferece dois caminhos. Escolha um antes de digitar comandos:
...
- **Caminho B — reconstruir do zero:** você cria cada pasta, instala as dependências e implementa as fatias na ordem dos capítulos. É o caminho recomendado para ministrar o workshop ou fixar o conteúdo.

Os dois chegam à mesma arquitetura. Não misture comandos sem observar o bloco “terminal” de cada etapa.
...
### 0.3 Caminho B: crie a base a partir de uma pasta vazia
