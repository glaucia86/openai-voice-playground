# Lab 02 — Live conversational voice agent with OpenAI Realtime, WebRTC, and Agents SDK
...
**Language:** [Leia em português](tutorial.md) · English
...
[Portuguese version](tutorial.md) · [← Module 01 — TTS](../../lab-01-text-to-speech/tutorial/tutorial-en.md) · [Workshop index](../../../docs/README.md) · [Optional environment module](../../../docs/00-configuracao-do-ambiente.md)
...
- **Run and investigate:** clone the finished app, run the gates, and inspect the flow with browser developer tools. Start here if Realtime, WebRTC, or Agents SDK is new to you.
- **Rebuild from zero:** create the directory and implement the slices in article order. Use this for a workshop or for a deeper understanding of every boundary.
...
### 0.6 Path B: create the application from zero
