# Laboratório 02 — Agente de voz conversacional ao vivo com OpenAI Realtime, WebRTC e Agents SDK
...
**Projeto:** [OpenAI Voice Labs](https://github.com/glaucia86/openai-voice-playground)  
...
Este laboratório pode ser usado de duas maneiras:

- **Executar e investigar:** clone o projeto pronto, rode os checks e acompanhe o fluxo no debugger. Use este caminho se Realtime, WebRTC ou Agents SDK ainda são novos para você.
- **Reconstruir do zero:** crie a pasta e os arquivos na ordem do workshop. Use este caminho para uma aula prática ou para entender por que cada camada existe.
...
### 0.3 Caminho B: crie uma aplicação vazia
